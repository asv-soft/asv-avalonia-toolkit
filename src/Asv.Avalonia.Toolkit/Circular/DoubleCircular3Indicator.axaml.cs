...
public class DoubleCircular3Indicator : IndicatorBase
{
    ...
    public static readonly StyledProperty<double> TopLeftProgressValueProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, double>(
    ...
    public static readonly StyledProperty<double> TopRightProgressValueProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, double>(
    ...
    public static readonly StyledProperty<double> TopLeftMinProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, double>(
        nameof(TopLeftMin), 0);
    ...
    public static readonly StyledProperty<double> TopLeftMaxProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, double>(
        nameof(TopLeftMax));
    ...
    public static readonly DirectProperty<DoubleCircular3Indicator, double> TopLeftProgressAngleProperty =
        AvaloniaProperty.RegisterDirect<DoubleCircular3Indicator, double>(
    ...
    public static readonly StyledProperty<double> TopRightMinProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, double>(
    ...
    public static readonly StyledProperty<double> TopRightMaxProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, double>(
        nameof(TopRightMax));
    ...
    public static readonly StyledProperty<double> TopRightValueProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, double>(
    ...
    public static readonly DirectProperty<DoubleCircular3Indicator, double> TopRightProgressAngleProperty =
        AvaloniaProperty.RegisterDirect<DoubleCircular3Indicator, double>(
    ...
    public static readonly DirectProperty<DoubleCircular3Indicator, Point> TopLeftProgressLinePointProperty =
        AvaloniaProperty.RegisterDirect<DoubleCircular3Indicator, Point>(
    ...
    public static readonly StyledProperty<IndicatorStatusEnum> TopLeftStatusProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, IndicatorStatusEnum>(
    ...
    public static readonly StyledProperty<Point> TopLeftProgressLineMinProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, Point>(
    ...
    public static readonly StyledProperty<Point> TopLeftProgressLineMaxProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, Point>(
    ...
    public static readonly DirectProperty<DoubleCircular3Indicator, Point> TopRightProgressLinePointProperty =
        AvaloniaProperty.RegisterDirect<DoubleCircular3Indicator, Point>(
    ...
    public static readonly StyledProperty<IndicatorStatusEnum> TopRightStatusProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, IndicatorStatusEnum>(
    ...
    public static readonly StyledProperty<Point> TopRightProgressLineMinProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, Point>(
    ...
    public static readonly StyledProperty<Point> TopRightProgressLineMaxProperty = AvaloniaProperty.Register<DoubleCircular3Indicator, Point>(
