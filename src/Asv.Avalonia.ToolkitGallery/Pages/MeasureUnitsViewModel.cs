...
public class MeasureUnitsViewModel: ViewModelBase, IShellPage
{
    ...
    public MeasureUnitsViewModel():base(Uri)
    {
        ...
        Icon = MaterialIconKind.Arena;
        Title = "Measure Controls";
          ...
          {
              Progress = 0;
              _recordTimer = Observable.Timer(TimeSpan.FromMilliseconds(100), TimeSpan.FromMilliseconds(100)).Subscribe(
                  _ =>
                  {
    ...
    [Reactive] public Point PointDoubleLeftTopLineEndPoint { get; set; } 
    [Reactive] public Point PointDoubleRightTopLineEndPoint { get; set; }
    [Reactive]
