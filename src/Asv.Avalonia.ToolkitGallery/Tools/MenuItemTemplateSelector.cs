...
public class MenuItemTemplateSelector : DataTemplateSelector
    {
        private readonly FuncDataTemplate<IShellMenuItem> _item = new((_, _) =>
        ...
        protected override IDataTemplate SelectTemplateCore(object item, Control container) => SelectTemplateCore(item);
    }